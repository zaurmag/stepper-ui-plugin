 ...
 * 1. Изменение текста
 * 2. Добавление класса active
 * 3. Добавление кнопке Назад атрибута disabled, если не на первом шаге
 * 4. Добавление класса done предыдущему шагу
 */
...
const App = {
  ...
  methods: {
    ...
    setActive(idx) {
      ...
      this.stepText = this.steps[idx].text;
